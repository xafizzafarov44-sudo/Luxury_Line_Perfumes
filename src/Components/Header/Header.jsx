    ...
    <div className="header-container">
      ...
      <nav className="nav">
        <ul className="nav-list">
          <li>
            <a className="nav-item" href="#home">{t("header.home")}</a>
            <a className="nav-item" href="#about">{t("header.about")}</a>
            <a className="nav-item" href="#services">{t("header.services")}</a>
            <a className="nav-item" href="#contact">{t("header.contact")}</a>
          </li>
        </ul>
      </nav>
